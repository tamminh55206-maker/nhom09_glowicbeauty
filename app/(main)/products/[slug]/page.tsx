      ...
      <div className="border-b bg-white">
        <div className="mx-auto max-w-7xl px-4 py-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span
              style={{ color: "#450920" }}
              className="truncate max-w-[300px] sm:max-w-none"
            >
              {product.name}
            </span>
          </nav>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-1">
              ...
              <span className="text-sm text-gray-400">
                Mã sản phẩm: {product.id.replace("product-", "")}
              </span>
            </div>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <button
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-lg border-2 py-4 font-bold transition-all duration-200 hover:-translate-y-1 hover:bg-gray-50 hover:shadow-lg hover:shadow-[#A53860]/30 disabled:opacity-50"
                style={{
                  borderColor: "#A53860",
                  color: "#A53860",
              ...
              <button
                ...
                disabled={product.stock === 0}
                className="flex flex-1 items-center justify-center gap-2 rounded-lg py-4 font-bold text-white transition-all duration-200 hover:-translate-y-1 hover:opacity-90 hover:shadow-lg hover:shadow-[#A53860]/50 disabled:opacity-50"
